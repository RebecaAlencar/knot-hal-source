...
static int nrf24L01_accept(int sockfd)
{
	...
	struct nrf24_ll_mgmt_connect *ipdu_pay = (void*)ipdu->payload;
	...
	if (ipdu_pay->dst_addr != addr_thing)
		return -1;
	 ...
	 */
	nrf24l01_set_data_settings(ipdu_pay->channel, ipdu_pay->aa, 1);
